...
void registerWetEtchingProcessModel() {
    ...
    wetEtchingProcess.description = "Anisotropic wet etching model for crystalline materials (e.g., Si in KOH/TMAH)";
    ...
    materialRateParam.documentation = "Rate multiplier for selected materials (1.0 = default rate)";
    ...
    auto factory = [](std::shared_ptr<void> psDomainVoid,
                      int dimension,
                      ...
                      const ParameterMap& params)
    {
        ...
        double processTime = registry.getParameter<double>(params, "ProcessTime", 100.0);
        double materialRateMultiplier = registry.getParameter<double>(params, "MaterialRateMultiplier", 1.0);
        double r100 = registry.getParameter<double>(params, "R100", 0.0166666666667);
        double r110 = registry.getParameter<double>(params, "R110", 0.0309166666667);
        double r111 = registry.getParameter<double>(params, "R111", 0.000121666666667);
        double r311 = registry.getParameter<double>(params, "R311", 0.0300166666667);

        double dir100_x = registry.getParameter<double>(params, "Direction100_X", 0.707106781187);
        double dir100_y = registry.getParameter<double>(params, "Direction100_Y", 0.707106781187);
        double dir100_z = registry.getParameter<double>(params, "Direction100_Z", 0.0);

        double dir010_x = registry.getParameter<double>(params, "Direction010_X", -0.707106781187);
        double dir010_y = registry.getParameter<double>(params, "Direction010_Y", 0.707106781187);
        double dir010_z = registry.getParameter<double>(params, "Direction010_Z", 0.0);

        viennacore::Vec3D<NumericType> direction100 = {dir100_x, dir100_y, dir100_z};
        viennacore::Vec3D<NumericType> direction010 = {dir010_x, dir010_y, dir010_z};
        ...
        ViennaPSModels::withDomain(psDomainVoid, dimension, [&](auto psDomain, auto dimTag) {
            constexpr int Dim = decltype(dimTag)::value;

                auto model = viennaps::SmartPointer<viennaps::WetEtching<NumericType, Dim>>::New(
                    direction100, direction010, r100, r110, r111, r311, materialRates
                );
                ...
                for (const auto& mat : materialRates) {
                    VPSLOG_DEBUG(nullptr, "  ", viennaps::MaterialMap::toString(mat.first), " (rate multiplier: ", mat.second, ")");
                }
...
void registerSF6O2EtchingProcessModel() {
    ...
    sf6o2Process.description = "SF6/O2 plasma etching model for Si with oxygen passivation";
    ...
    sigmaEnergyParam.documentation = "Standard deviation of ion energy distribution";
    ...
    etchStopParam.documentation = "Z-coordinate to stop etching. Leave at minimum for no stop.";
    ...
    betaPParam.documentation = "Sticking probability of passivation species (oxygen)";
    ...
    lengthUnitParam.enumOptions = {"Nanometer", "Micrometer", "Millimeter", "Centimeter", "Meter", "Angstrom"};
                      ...
                      const ParameterMap& params)
    {
        ...
        switch(lengthUnit) {
            case 0: viennaps::units::Length::setUnit(viennaps::units::Length::NANOMETER); break;
            case 1: viennaps::units::Length::setUnit(viennaps::units::Length::MICROMETER); break;
            case 2: viennaps::units::Length::setUnit(viennaps::units::Length::MILLIMETER); break;
            case 3: viennaps::units::Length::setUnit(viennaps::units::Length::CENTIMETER); break;
            case 4: viennaps::units::Length::setUnit(viennaps::units::Length::METER); break;
            case 5: viennaps::units::Length::setUnit(viennaps::units::Length::ANGSTROM); break;
            default: viennaps::units::Length::setUnit(viennaps::units::Length::NANOMETER); break;
        }

        switch(timeUnit) {
            case 0: viennaps::units::Time::setUnit(viennaps::units::Time::SECOND); break;
            case 1: viennaps::units::Time::setUnit(viennaps::units::Time::MINUTE); break;
            case 2: viennaps::units::Time::setUnit(viennaps::units::Time::MILLISECOND); break;
            default: viennaps::units::Time::setUnit(viennaps::units::Time::SECOND); break;
        }


        double processTime = registry.getParameter<double>(params, "ProcessTime", 10.0);
        double ionFlux = registry.getParameter<double>(params, "IonFlux", 12.0);
        double etchantFlux = registry.getParameter<double>(params, "EtchantFlux", 1800.0);
        double oxygenFlux = registry.getParameter<double>(params, "OxygenFlux", 100.0);
        double meanEnergy = registry.getParameter<double>(params, "MeanEnergy", 100.0);
        double sigmaEnergy = registry.getParameter<double>(params, "SigmaEnergy", 10.0);
        double ionExponent = registry.getParameter<double>(params, "IonExponent", 500.0);
        double oxySputterYield = registry.getParameter<double>(params, "OxygenSputterYield", 3.0);
        double etchStopDepth = registry.getParameter<double>(params, "EtchStopDepth",
        ...
        ViennaPSModels::withDomain(psDomainVoid, dimension, [&](auto psDomain, auto dimTag) {
            constexpr int Dim = decltype(dimTag)::value;
                ...
                auto sf6o2Params = viennaps::SF6O2Etching<NumericType, Dim>::defaultParameters();
                ...
                auto model = viennaps::SmartPointer<viennaps::SF6O2Etching<NumericType, Dim>>::New(
                    sf6o2Params
                );

                VPSLOG_DEBUG(nullptr, "Ion flux: ", ionFlux, " (1e15 /cm²/s)");
                VPSLOG_DEBUG(nullptr, "Etchant flux: ", etchantFlux, " (1e15 /cm²/s)");
...
void registerSF6C4F8EtchingProcessModel() {
    ...
    sf6c4f8Process.description = "SF6/C4F8 plasma etching model for Si with polymer layer etching (no passivation)";
    ...
    polymerDensityParam.documentation = "C4F8 polymer layer density (1e22 atoms/cm³)";
    ...
    polymerThresholdParam.documentation = "Threshold energy for polymer sputtering";
                      ...
                      const ParameterMap& params)
    {
        ...
        double betaE = registry.getParameter<double>(params, "BetaE", 0.7);
        double kSigma = registry.getParameter<double>(params, "KSigma", 300.0);
        double polymerDensity = registry.getParameter<double>(params, "PolymerDensity", 5.0);
        double polymerThreshold = registry.getParameter<double>(params, "PolymerThresholdEnergy", 15.0);

        ViennaPSModels::withDomain(psDomainVoid, dimension, [&](auto psDomain, auto dimTag) {
            constexpr int Dim = decltype(dimTag)::value;

                auto sf6c4f8Params = viennaps::SF6C4F8Etching<NumericType, Dim>::defaultParameters();
                ...
                auto model = viennaps::SmartPointer<viennaps::SF6C4F8Etching<NumericType, Dim>>::New(
                    sf6c4f8Params
                );
...
void registerOxideRegrowthProcessModel() {
    ...
    oxideRegrowthProcess.description = "Selective etching with oxide redeposition and byproduct diffusion dynamics";
    ...
    redepoTimeIntParam.documentation = "Time interval between redeposition events (s)";
    ...
    sinkStrengthParam.documentation = "Strength of byproduct removal at top boundary";
    ...
    scallopVelParam.documentation = "Velocity of byproduct stream at scallop regions";
    ...
    timeStabilityParam.documentation = "Factor for numerical time step stability (0-1)";
                      ...
                      const ParameterMap& params)
    {
        ...
        double processTime = registry.getParameter<double>(params, "ProcessTime", 100.0);
        double nitrideEtchRate = registry.getParameter<double>(params, "NitrideEtchRate", 1.0);
        double oxideEtchRate = registry.getParameter<double>(params, "OxideEtchRate", 0.1);
        double redepositionRate = registry.getParameter<double>(params, "RedepositionRate", 1.0);
        double redepositionThreshold = registry.getParameter<double>(params, "RedepositionThreshold", 0.1);
        double redepositionTimeInt = registry.getParameter<double>(params, "RedepositionTimeInterval", 60.0);
        double diffusionCoeff = registry.getParameter<double>(params, "DiffusionCoefficient", 1.0);
        double sinkStrength = registry.getParameter<double>(params, "SinkStrength", 1.0);
        double scallopVelocity = registry.getParameter<double>(params, "ScallopVelocity", 1.0);
        double centerVelocity = registry.getParameter<double>(params, "CenterVelocity", 1.0);
        double topHeight = registry.getParameter<double>(params, "TopHeight", 100.0);
        double centerWidth = registry.getParameter<double>(params, "CenterWidth", 50.0);
        double timeStabilityFactor = registry.getParameter<double>(params, "TimeStabilityFactor", 0.245);

        ViennaPSModels::withDomain(psDomainVoid, dimension, [&](auto psDomain, auto dimTag) {
            constexpr int Dim = decltype(dimTag)::value;

                auto model = viennaps::SmartPointer<viennaps::OxideRegrowth<NumericType, Dim>>::New(
                    nitrideEtchRate, oxideEtchRate, redepositionRate, redepositionThreshold,
                    redepositionTimeInt, diffusionCoeff, sinkStrength, scallopVelocity,
                    centerVelocity, topHeight, centerWidth, timeStabilityFactor
                );
                ...
                VPSLOG_DEBUG(nullptr, "Redeposition threshold: ", redepositionThreshold);
                VPSLOG_DEBUG(nullptr, "Redeposition time interval: ", redepositionTimeInt, " s");
                ...
                if (!psDomain->getCellSet()) {
                    ...
                    psDomain->generateCellSet(2 * gridDelta, viennaps::Material::GAS, true);
                }
...
void registerIonBeamEtchingProcessModel() {
    ...
    ionBeamProcess.description = "Physical ion beam etching with optional redeposition";
    ...
    tiltAngleParam.documentation = "Ion beam tilt angle from surface normal (degrees)";
    ...
    inflectAngleParam.documentation = "Angle for energy reflection inflection point (degrees)";
    ...
    minAngleParam.documentation = "Minimum angle for reflected particles (degrees)";
    ...
    redepositionRateParam.name = "RedepositionRate";
    redepositionRateParam.displayName = "Redeposition Rate";
    redepositionRateParam.documentation = "Rate of material redeposition (0 = disabled)";
    redepositionRateParam.type = ParameterType::DOUBLE;
    ...
    redepositionThresholdParam.documentation = "Threshold for material redeposition";
    ...
    yieldFunctionParam.enumOptions = {"Constant", "Cosine", "Cosine Power", "Custom", "Cos4"};
                      ...
                      const ParameterMap& params)
    {
        ...
        double processTime = registry.getParameter<double>(params, "ProcessTime", 10.0);
        double planeWaferRate = registry.getParameter<double>(params, "PlaneWaferRate", 1.0);
        double meanEnergy = registry.getParameter<double>(params, "MeanEnergy", 250.0);
        double sigmaEnergy = registry.getParameter<double>(params, "SigmaEnergy", 10.0);
        double thresholdEnergy = registry.getParameter<double>(params, "ThresholdEnergy", 20.0);
        double tiltAngle = registry.getParameter<double>(params, "TiltAngle", 0.0);
        double ionExponent = registry.getParameter<double>(params, "IonExponent", 100.0);
        double n_l = registry.getParameter<double>(params, "NL", 10.0);
        double inflectAngle = registry.getParameter<double>(params, "InflectAngle", 89.0);
        double minAngle = registry.getParameter<double>(params, "MinAngle", 85.0);
        double redepositionRate = registry.getParameter<double>(params, "RedepositionRate", 0.0);
        double redepositionThreshold = registry.getParameter<double>(params, "RedepositionThreshold", 0.1);
        int yieldFunctionType = registry.getParameter<int>(params, "YieldFunction", 0);
        double yieldPower = registry.getParameter<double>(params, "YieldPower", 1.0);
        ...
        bool rotatingWafer = registry.getParameter<int>(params, "RotatingWafer", 0) != 0;
        ...
        ViennaPSModels::withDomain(psDomainVoid, dimension, [&](auto psDomain, auto dimTag) {
            constexpr int Dim = decltype(dimTag)::value;
                ...
                auto model = viennaps::SmartPointer<viennaps::IonBeamEtching<NumericType, Dim>>::New(
                    ibeParams, maskMaterials
                );
                ...
                if (redepositionRate > 0) {
                    VPSLOG_DEBUG(nullptr, "Redeposition enabled - Rate: ", redepositionRate, ", Threshold: ", redepositionThreshold);
                }
...
void registerHBrO2EtchingProcessModel() {
    ...
    hbro2Process.description = "HBr/O2 plasma etching model for Si with passivation";
                      ...
                      const ParameterMap& params)
    {
        ...
        ViennaPSModels::withDomain(psDomainVoid, dimension, [&](auto psDomain, auto dimTag) {
            constexpr int Dim = decltype(dimTag)::value;
                ...
                auto hbrParams = viennaps::HBrO2Etching<NumericType, Dim>::defaultParameters();
                ...
                auto model = viennaps::SmartPointer<viennaps::HBrO2Etching<NumericType, Dim>>::New(
                    hbrParams
                );
...
void registerFluorocarbonEtchingProcessModel() {
    ...
    fluorocarbonProcess.description = "Fluorocarbon plasma etching model for SiO2, Si, Si3N4 with polymer deposition";
                      ...
                      const ParameterMap& params)
    {
        ...
        double etchantFlux = registry.getParameter<double>(params, "EtchantFlux", 500.0);
        double polymerFlux = registry.getParameter<double>(params, "PolymerFlux", 100.0);
        double meanEnergy = registry.getParameter<double>(params, "MeanEnergy", 100.0);
        double sigmaEnergy = registry.getParameter<double>(params, "SigmaEnergy", 10.0);
        double temperature = registry.getParameter<double>(params, "Temperature", 300.0);
        double ionExponent = registry.getParameter<double>(params, "IonExponent", 500.0);
        ...
        ViennaPSModels::withDomain(psDomainVoid, dimension, [&](auto psDomain, auto dimTag) {
            constexpr int Dim = decltype(dimTag)::value;
                ...
                viennaps::FluorocarbonParameters<NumericType>::MaterialParameters matParams;
                matParams.beta_p = beta_p;
                matParams.beta_e = beta_e;
                fluoroParams.addMaterial(matParams);

                auto model = viennaps::SmartPointer<viennaps::FluorocarbonEtching<NumericType, Dim>>::New(
                    fluoroParams
                );

                VPSLOG_DEBUG(nullptr, "Ion flux: ", ionFlux, " (1e15 /cm²/s)");
                VPSLOG_DEBUG(nullptr, "Etchant flux: ", etchantFlux, " (1e15 /cm²/s)");
                VPSLOG_DEBUG(nullptr, "Polymer flux: ", polymerFlux, " (1e15 /cm²/s)");
                VPSLOG_DEBUG(nullptr, "Mean ion energy: ", meanEnergy, " eV");
...
void registerCF4O2EtchingProcessModel() {
    ...
    cf4o2Process.description = "Advanced plasma etching model with CF4/O2 chemistry for Si and SiGe etching";
                      ...
                      const ParameterMap& params)
    {
        ...
        double ionExponent = registry.getParameter<double>(params, "IonExponent", 500.0);
        double oxySputterYield = registry.getParameter<double>(params, "OxygenSputterYield", 3.0);
        double polySputterYield = registry.getParameter<double>(params, "PolymerSputterYield", 3.0);
        double etchStopDepth = registry.getParameter<double>(params, "EtchStopDepth",
                                                            std::numeric_limits<NumericType>::lowest());
        ...
        ViennaPSModels::withDomain(psDomainVoid, dimension, [&](auto psDomain, auto dimTag) {
            constexpr int Dim = decltype(dimTag)::value;
                ...
                auto model = viennaps::SmartPointer<viennaps::CF4O2Etching<NumericType, Dim>>::New(
                    cf4o2Params
                );
...
void registerFaradayCageEtchingProcessModel() {
    ...
    faradayCageProcess.description = "Ion beam etching through a Faraday cage with two-directional ion source";
                      ...
                      const ParameterMap& params)
    {
        ...
        ViennaPSModels::withDomain(psDomainVoid, dimension, [&](auto psDomain, auto dimTag) {
            constexpr int Dim = decltype(dimTag)::value;
                ...
                switch(yieldFunctionType) {
                    case 0:
                        fcParams.ibeParams.yieldFunction = [](NumericType theta) { return 1.0; };
                        break;
                    case 1:
                ...
                auto model = viennaps::SmartPointer<viennaps::FaradayCageEtching<NumericType, Dim>>::New(
